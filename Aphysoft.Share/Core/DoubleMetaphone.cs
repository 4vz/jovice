...
namespace Aphysoft.Share
{
    ...
    public class DoubleMetaphone
    {
        ...
        public static bool Similar(DoubleMetaphone first, DoubleMetaphone second)
        {
            if (first.PrimaryKey == second.PrimaryKey && first.AlternateKey == second.AlternateKey) return true;
            else return false;
        }

        public static bool Similar(string first, string second)
        {
            return Similar(new DoubleMetaphone(first), new DoubleMetaphone(second));
        }
