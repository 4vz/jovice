...
(function () {
    ...
    ui("search_jovice_interface", function (b, r, f, p, t) {
        ...
        if (f.create) {
            r.nodeName = ui.text(b)({ font: ["body", 15], color: 25, weight: "600", top: 13, left: 20, noBreak: true, clickToSelect: true, cursor: "copy" });
            r.interfaceName = ui.text(b)({ font: ["body", 15], color: "accent", weight: "600", noBreak: true, clickToSelect: true, cursor: "copy", attach: [r.nodeName, "right", 20] });
            r.interfaceDesc = ui.text(b)({ font: ["body", 15], color: 25, noBreak: true, truncate: true, attach: [r.interfaceName, "right2", 20, 20] });
        }
