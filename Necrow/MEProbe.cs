                    ...
                    else
                    {
                        ...
                        if (tokens.Length == 6)
                        {
                            ...
                            if (tokens[2].StartsWith("sdp:"))
                            {
                                ...
                                if (peerlive.ContainsKey(sdpt))
                                {
                                    li.PeerID = peerlive[sdpt].ID;
                                    keydis = li.PeerID;
                                    circuitID = peerlive[sdpt].CircuitID;
                                }
                            }
                            else if (tokens[2].StartsWith("sap:"))
                            {
                                string sapt = ConvertALUPort(tokens[2].Substring(4));
                                if (interfacelive.ContainsKey(sapt))
                                {
                                    li.InterfaceID = interfacelive[sapt].ID;
                                    keydis = li.InterfaceID;
                                    circuitID = interfacelive[sapt].CircuitID;
                                }
                            }
